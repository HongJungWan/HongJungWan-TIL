...
- 클라우드 환경에서 가상 머신, 스토리지, 네트워킹 등의 인프라를 제공하는 서비스.
- 사용자는 가상 환경을 직접 관리하고 애플리케이션을 설치하고 관리해야 한다.
    - 예를 들면, Azure Virtual Machines

<br/>

### PaaS (Platform as a Service)

- 컨테이너에서 또는 Windows 또는 Linux에서 실행 되는 .NET, Java, Python, PHP 작업 등 수행
- 원하는 방식으로 웹앱과 API를 빠르게 빌드, 배포 및 스케일링
    - 예를 들면, Azure App Service
